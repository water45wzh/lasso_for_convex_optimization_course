...
tic; 
[x3, iter3, out3] = l1_GD_primal(x0, A, b, mu, opts3);
t3 = toc;
sp3 = get_sparsity(x3);
...
tic; 
[x4, iter4, out4] = l1_FGD_primal(x0, A, b, mu, opts4);
t4 = toc;
sp4 = get_sparsity(x4);
...
tic; 
[x5, iter5, out5] = l1_ProxGD_primal(x0, A, b, mu, opts5);
t5 = toc;
sp5 = get_sparsity(x5);
...
tic; 
[x6, iter6, out6] = l1_FProxGD_primal(x0, A, b, mu, opts6);
t6 = toc;
sp6 = get_sparsity(x6);
...
fprintf('             GD: cpu: %5.2f, iter: %d, err-to-cvx-mosek: %3.2e\n', t3, iter3, errfun(x1, x3));
fprintf('            FGD: cpu: %5.2f, iter: %d, err-to-cvx-mosek: %3.2e\n', t4, iter4, errfun(x1, x4));
fprintf('         ProxGD: cpu: %5.2f, iter: %d, err-to-cvx-mosek: %3.2e\n', t5, iter5, errfun(x1, x5));
fprintf('        FProxGD: cpu: %5.2f, iter: %d, err-to-cvx-mosek: %3.2e\n', t6, iter6, errfun(x1, x6));
